...
begin
    btnGeneral.Font.Style := btnGeneral.Font.Style - [TFontStyle.fsBold];
    btnGPS.Font.Style := btnGPS.Font.Style - [TFontStyle.fsBold];
    btnGateway.Font.Style := btnGateway.Font.Style - [TFontStyle.fsBold];
    btnUDP.Font.Style := btnUDP.Font.Style - [TFontStyle.fsBold];
